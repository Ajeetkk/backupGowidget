...
var UserComponent = function (_React$Component) {
    ...
    function UserComponent(props) {
        ...
        _this.ChangeTab = function (tabName) {
            switch (tabName) {
                case 'Active':
                    ...
                    _this.setState({ "Page": 1, "IsActive": _this.state.IsActive, "Sort": _this.state.Sort });
                    _this.loadUsers(_this.state.Page);
                    break;
                case 'Invited':
                    _this.tabs = [{ "Name": 'Active', "IsActive": false }, { "Name": 'Invited', "IsActive": true }];
        ...
        console.log("props on user control = ", props);
        console.log("props on user control = ", this.props);
        ...
        _this.state = {
            ...
            IsCheckbox: true,
            RolesData: [],
            DataFromConsuming: _this.props.nameBosch
        };
        _this.loadRoles();
        _this.loadUsers(_this.state.Page);
        _this.tabs = [{ "Name": 'Active', "IsActive": true }, { "Name": 'Invited', "IsActive": false }];
    ...
    _createClass(UserComponent, [{
        ...
        value: function loadRoles() {
            ...
            this.userService.getUsersMasterRoles(this.props.Url).then(function (data) {
                ...
                // console.log(_this2.state.RolesData);
            });
        }
    }, {
        key: 'loadUsers',
        value: function loadUsers(page) {
            ...
            this.userService.getAllUser(config, this.props.Url).then(function (data) {
        ...
        value: function loadInviteUsers(page) {
            ...
            this.userService.getInviteUsers(config, this.props.Url).then(function (data) {
                var userData = data.packet.body.result.users;
        ...
        value: function prepareActiveHeader() {
            // Prepare Head
            var lstHead = [];
            lstHead.push({ "Text": "", "IsDefault": true, "IsSort": true, "Type": "CheckBox" });
            lstHead.push({ "Text": "Name", "IsDefault": true, "IsSort": true, "Type": "Text" });
            lstHead.push({ "Text": "Email", "IsDefault": false, "IsSort": true, "Type": "Text" });
            lstHead.push({ "Text": "Phone", "IsDefault": false, "IsSort": true, "Type": "Text" });
            lstHead.push({ "Text": "Manage role", "IsDefault": false, "IsSort": true, "Type": "Text" });
            lstHead.push({ "Text": "Action", "IsDefault": false, "IsSort": false, "Type": "Text" });
            return lstHead;
        }
    }, {
        ...
        value: function prepareInviteHeader() {
            // Prepare Head
            var lstHead = [];
            lstHead.push({ "Text": "Email", "IsDefault": true, "IsSort": true, "Type": "Text" });
            lstHead.push({ "Text": "Manage role", "IsDefault": false, "IsSort": true, "Type": "Text" });
            lstHead.push({ "Text": "Action", "IsDefault": false, "IsSort": false, "Type": "Text" });
            return lstHead;
        }
        ...
        value: function prepareInviteBody(userData) {
            ...
            var lstBody = [];
            userData.forEach(function (e) {
                lstBody.push({ "body": [{ "Text": e.emailId, "Type": "Email" }, { "Text": _this6.prepeareUserView(e.modules), "Type": "Link" }, { "Text": ["revokeIcon", "reloadIcon"], "Type": "Icon" }] });
            });
            return lstBody;
        }
    }, {
        ...
        value: function prepeareUserView(modules) {
            ...
            return userViewString == '' ? 'Assign Role' : userViewString;
        }
    }, {
        key: 'render',
        value: function render() {
            ...
            return _react2.default.createElement(
                'div',
                null,
                this.state.DataFromConsuming,
                _react2.default.createElement(_user2.default, { header: this.state.Header, body: this.state.Body, IsCheckBox: this.state.IsCheckbox, search: this.SearchUser, Filter: this.FilterUser, Sort: this.Sortuser, Pagination: this.props.Pagination, TabButtons: this.tabs, TabChange: this.ChangeTab, FilterData: [this.state.RolesData], IsActivated: this.IsActivated })
            );
        }
    }]);
